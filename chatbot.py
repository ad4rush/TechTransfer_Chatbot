...
def generate_answers_for_batch(key_for_first_attempt, question_batch, processed_pdf_text, batch_name_for_logging="Unnamed Batch"):
    ...
    for attempt in range(MAX_API_RETRIES_QNA):
        try:
            # On the first attempt, use the provided key. On retries, get a new one.
            if attempt > 0 or not current_api_key_for_this_specific_attempt:
                ...
                # This call will now BLOCK until a key is available.
            ...
            if not chat_model:
                ...
                if attempt < MAX_API_RETRIES_QNA - 1:
                    ...
                    current_api_key_for_this_specific_attempt = None # Force getting a new key
                    continue
                else:
                    break
        ...
        except Exception as e: # Handles other API errors (e.g., 429, 500)
            ...
            if attempt < MAX_API_RETRIES_QNA - 1:
                ...
                current_api_key_for_this_specific_attempt = None # Force getting a new key on next retry
            else:
